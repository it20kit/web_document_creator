...
class DocumentTools:
    ...
    def add_content_for_cell_table(self, cell, content, alignment, style: dict) -> None:
        """Добавить текст в ячейку таблицы с переданными параметрами"""
        text = cell.paragraphs[0].add_run(content)
        cell.paragraphs[0].alignment = alignment
        self.set_text_style_by_parameters(text, style)
    ...
    # @staticmethod
    # def set_text_style_by_parameters(text, style: dict) -> None:
